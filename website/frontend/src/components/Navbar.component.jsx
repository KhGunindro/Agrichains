    ...
    <AnimatePresence>
      {visible && (
        <motion.nav
          ...
          className={`fixed top-0 left-0 right-0 p-4 sm:p-6 flex justify-between items-center ${darkMode ? "bg-gray-800/100" : "bg-white/100"
            } drop-shadow-lg z-50`}
        >
          ...
          <div className="hidden sm:flex items-center space-x-3 sm:space-x-4">
            ...
            {location.pathname !== "/" && location.pathname !== "/auth" && (
              <Link
                to="/"
                className={`p-1 sm:p-2 rounded-full flex items-center space-x-2 ${darkMode ? "hover:bg-white hover:text-black" : "hover:bg-gray-700 hover:text-white"
                  }`}
              >
            ...
            {isMenuOpen && (
              ...
              >
                {location.pathname !== "/" && location.pathname !== "/auth" && (
                  <Link
                    to="/"
                    className={`p-2 font-bold ${darkMode ? "hover:bg-white hover:text-black" : "hover:bg-gray-700 hover:text-white"
                      }`}
                ...
                {location.pathname === "/" && (
                  <button
                    ...
                    className={`p-2 text-left font-bold ${darkMode ? "hover:bg-white hover:text-black" : "hover:bg-gray-700 hover:text-white"
                      }`}
                  >
                    Future Team
                  </button>
