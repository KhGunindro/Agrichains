    ...
    <AnimatePresence>
      {visible && (
        <motion.nav
          ...
          className={`fixed top-0 left-0 right-0 p-4 sm:p-6 flex justify-between items-center ${darkMode ? "bg-gray-800/100" : "bg-white/100"} drop-shadow-lg z-50`}
        >
          ...
          <div className="hidden sm:flex items-center space-x-3 sm:space-x-4">
            {location.pathname !== "/documentation" && (
              <Link to="/documentation" className={`p-1 font-bold sm:p-2 relative inline-block ${darkMode ? "text-white" : "text-gray-900"} hover:no-underline group`}>
                Documentation
            ...
            {location.pathname !== "/contact" && (
              <Link to="/contact" className={`p-1 sm:p-2 rounded-full ${darkMode ? "hover:bg-white hover:text-black" : "hover:bg-gray-700 hover:text-white"}`}>
          ...
          <div className="flex sm:hidden items-center space-x-3">
            ...
            <button onClick={() => setIsMenuOpen(!isMenuOpen)} className={`p-1 sm:p-2 rounded-full ${darkMode ? "hover:bg-white hover:text-black" : "hover:bg-gray-700 hover:text-white"}`}>
